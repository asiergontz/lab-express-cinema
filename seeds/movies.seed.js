...
// make sure the database is called `lab-mongoose-movies` or whatever you named it
...
// This script will be runned only once, we call the command "node seeds/movies.seed.js" in the terminal
// And then we can check the database in Mongo to see if the data was added
